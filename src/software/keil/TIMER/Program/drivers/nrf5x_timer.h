...
#define TIMER_TASKS_SHUTDOWN(__INS)         (__INS->TASKS_CLEAR = SET)          // Shut down timer
#define TIMER_TASKS_CAPTURE(__INS, __CH)    (__INS->TASKS_CAPTURE[__CH] = SET)  // Capture Timer value to CC[x] register

#define TIMER_EVENT_COPPARE(__INS, __CH)    __INS->EVENTS_COMPARE[__CH]         // Compare event on CC[x] match

...
/* Private typedef -------------------------------------------------------------------------*/
/* Private define --------------------------------------------------------------------------*/
#define I2CxS_SCL_L()         __GPIO_RST(pSimuI2c->PinSCL)
#define I2CxS_SCL_H()         __GPIO_SET(pSimuI2c->PinSCL)
#define I2CxS_SCL_READ()      (__GPIO_READ(pSimuI2c->PinSCL) == 1)

#define I2CxS_SDA_L()         __GPIO_RST(pSimuI2c->PinSDA)
#define I2CxS_SDA_H()         __GPIO_SET(pSimuI2c->PinSDA)
#define I2CxS_SDA_READ()      (__GPIO_READ(pSimuI2c->PinSDA) == 1)

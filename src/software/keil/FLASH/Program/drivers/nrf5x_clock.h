...
/* Exported constants ----------------------------------------------------------------------*/
/* Exported macro --------------------------------------------------------------------------*/
#define CLOCK_TASKS_HFCLKSTART()    (NRF_CLOCK->TASKS_HFCLKSTART = SET)     // Start HFCLK crystal oscillator
#define CLOCK_TASKS_HFCLKSTOP()     (NRF_CLOCK->TASKS_HFCLKSTOP = SET)      // Stop HFCLK crystal oscillator
#define CLOCK_TASKS_LFCLKSTART()    (NRF_CLOCK->TASKS_LFCLKSTART = SET)     // Start LFCLK source
#define CLOCK_TASKS_LFCLKSTOP()     (NRF_CLOCK->TASKS_LFCLKSTOP = SET)      // Stop LFCLK source
#define CLOCK_TASKS_CAL()           (NRF_CLOCK->TASKS_CAL = SET)            // Start calibration of LFCLK RC oscillator
#define CLOCK_TASKS_CTSTART()       (NRF_CLOCK->TASKS_CTSTART = SET)        // Start calibration timer
#define CLOCK_TASKS_CTSTOP()        (NRF_CLOCK->TASKS_CTSTOP = SET)         // Stop calibration timer

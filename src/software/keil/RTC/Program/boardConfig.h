...
#define RTCx                          NRF_RTC0
#define RTCx_IRQn                     RTC0_IRQn
#define RTCx_IRQn_PRIORITY            1
#define RTCx_CLOCK_FREQ               50   // 50 Hz

#define RTCx_CHANNEL                  NRF_RTC_COMPARE0
#define RTCx_CHANNEL_PERIOD           50   // 1 Hz

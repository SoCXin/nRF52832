...
/* Private macro ---------------------------------------------------------------------------*/
/* Private variables -----------------------------------------------------------------------*/
extern TIMER_TimeBaseInitTypeDef htick;
...
{
  if (TIMER_EVENTS_COPPARE(htick.Instance, TIMERx_CHANNEL) != RESET) {
    TIMER_EVENTS_COPPARE(htick.Instance, TIMERx_CHANNEL) = RESET;
    TIMER_TASKS_CLEAR(htick.Instance) = SET;
    htick.EventCallback();
  }
}
